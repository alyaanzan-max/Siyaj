...
# --- ❓ 9. الدليل التشغيلي (شرح المنظومة بلمسة علو) ---
   ...
   with st.expander("📖 شرح قسم 🏠 العمليات المركزية:"):
        st.write("""
            هذا القسم يمثل مركز الإدارة والتحكم (Dashboard). تقنياً، هو الشاشة التي تجمع كافة البيانات من الأقسام الأخرى لتعرضها بشكل مركزي. وظيفته هي المراقبة اللحظية، حيث يتم رصد حالة النظام، وتدفق البيانات، والتأكد من أن جميع الدروع الرقمية تعمل بكفاءة. هو باختصار "نقطة المرجعية" لأي قرار أمني يتم اتخاذه داخل المنصة.
        """)
