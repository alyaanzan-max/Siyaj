...
if section == "الرئيسية 🏠":
   ...
   with t1:
        ...
        <ul>
            <li><b>🧠 خبيرات المنطق الرياضي:</b> نعتمد في بناء خوارزميات سياج على تفكير منطقي متقدم، صُقل من خلال المنافسة في المحافل الدولية مثل مسابقات "كانجارو" و "موهبة" (نسمو) للرياضيات، مما يجعل نظامنا دقيقاً في رصد الثغرات.</li>
            <br>
