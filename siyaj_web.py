...
if section == "الرئيسية 🏠":
...
elif section == "ركن الابتكار 💡":st.title("💡 مختبر الابتكار والسيادة الرقمية")
    ...
    with t1:
        ...
        <ul>
            <li><b>🧠 خبيرات المنطق الرياضي:</b> نعتمد في بناء خوارزميات سياج على تفكير منطقي متقدم، صُقل من خلال المنافسة في المحافل الدولية مثل مسابقات "كانجارو" و "موهبة" (نيسمو) للرياضيات، مما يجعل نظامنا دقيقاً في رصد الثغرات.</li>
            <br>
            <li><b>🇸🇦 سفيرات الهوية والتقنية:</b> نحن نريد أن نثبت للعالم أن الاعتزاز بالهوية الوطنية لا يتعارض مع لغات البرمجة العالمية (Python)؛ بل هو المحرك الأساسي لحماية مقدرات الوطن.</li>
            <br>
            <li><b>👤 رواد هندسة الوعي:</b> نمتلك قدرة عالية على تحليل السلوك البشري الرقمي، وهذا ما دفعنا لابتكار المساعد "سند"، ليكون درعاً يحمي المستخدم من الخداع قبل الاختراق التقني.</li>
        </ul>
        </div>""", unsafe_allow_html=True)
